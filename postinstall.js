...
(function() {
  const webpackConfigFile = 'node_modules/@angular-devkit/build-angular/src/angular-cli-files/models/webpack-configs/browser.js';
  const filePath = path.join(process.cwd(), webpackConfigFile);
